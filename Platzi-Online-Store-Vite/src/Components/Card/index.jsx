    ...
    return(
        ...
        className="bg-white cursor-pointer w-56  rounded-lg">
            <figure className="relative mb-2 w-full h-4/5">
                ...
                className="absolute top-0 right-0 flex justify-center items-center rounded-full bg-white w-6 h-6 m-2 p-1"><PlusCircleIcon className="h-6 w-6 text-black"></PlusCircleIcon></div>
            </figure>
